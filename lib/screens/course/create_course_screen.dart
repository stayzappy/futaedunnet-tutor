...
class _CreateCourseScreenState extends State<CreateCourseScreen> {
  ...
  Future<void> _pickDisplayPicture() async {
    try {
      ...
      if (result != null && result.files.isNotEmpty) {
        ...
        if (mounted) {
          SuccessSnackBar.show(context, 'Image selected successfully');
        }
      }
    } catch (e) {
      if (mounted) {
  ...
  Future<void> _handleCreateCourse() async {
    ...
    if (mounted) {
      if (success) {
        SuccessSnackBar.show(context, AppConstants.courseCreatedSuccess);
        Navigator.pop(context);
      } else {
        ErrorSnackBar.show(
          context,
          courseProvider.errorMessage ?? 'Failed to create course',
        );
      }
    }
  }
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomButton(
                    label: 'Create Course',
                    onPressed: courseProvider.isLoading ? null : _handleCreateCourse,
                    isLoading: courseProvider.isLoading,
